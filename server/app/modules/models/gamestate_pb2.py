...
_GAMESTATE.fields_by_name['currentQuestion'].message_type = models_dot_question__pb2._QUESTION
...
GameState = _reflection.GeneratedProtocolMessageType('GameState', (_message.Message,), dict(
  ...
  __module__ = 'models.gamestate_pb2'
